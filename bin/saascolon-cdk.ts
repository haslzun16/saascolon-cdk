...
import { PhoneOnlyPasswordLessStack } from '../lib/aws-cognito/phone-only-password-less/phone-only-password-less-stack';
...
new PhoneOnlyPasswordLessStack(app, 'PhoneOnlyPasswordLessStack', { env: { region: 'us-east-1', account: 'AWS-ACCOUNT-NO' } });
